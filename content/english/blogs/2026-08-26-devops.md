...
Twenty years ago, Jeff Barr posted a blog entry introducing a single instance type — m1.small — in one region, billed by the hour. That was [Amazon EC2](https://aws.amazon.com/blogs/aws/happy-20th-birthday-amazon-ec2/?utm_source=tldrdevops) on August 25, 2006. Today it offers over 1,200 instance types across 39 Regions.
...
Two guest-to-host escape vulnerabilities landed in a cloud near you this summer, and [DigitalOcean's Kernel Engineering team documented exactly how they handled both](https://www.digitalocean.com/blog/patching-januscape-amd-safe-ret?utm_source=tldrdevops). The first, Januscape (CVE-2026-53359), was a KVM nested virtualization flaw publicly disclosed on July 6. DigitalOcean built a livepatch within 45 minutes of the disclosure page going up and achieved full fleet coverage within 48 hours. Zero confirmed customer impact.
...
When you have hundreds of microservices, a single degraded user experience can be caused by any one of dozens of components in any order. Atlassian has [published its system for automating root cause analysis](https://www.cncf.io/blog/2026/08/24/automating-root-cause-analysis-at-scale-multi-signal-correlation-for-cloud-native-incident-response/?utm_source=tldrdevops) across that sprawl.
...
[A contrarian take this week](https://larsfaye.com/articles/ai-coding-will-prevent-expertise?utm_source=tldrdevops) argues that AI coding tools create a paradox: they require expertise to use effectively while simultaneously bypassing the friction that builds that expertise. Developers entering the field during the LLM era lack the longevity of experience that veterans have, yet are pressured to use agents that demand expert-level judgment to evaluate. The "skilled orchestrator paradox" — the skills required to manage AI agents are the same ones that get atrophied through their use.
...
[Databricks shipped a workflow improvement](https://www.databricks.com/blog/run-debug-and-scale-databricks-workloads-your-local-ide?utm_source=tldrdevops) that connects VS Code, Cursor, or a terminal directly to Databricks compute via SSH tunnel. Engineers can interactively run and debug Python and SQL on real Databricks clusters while keeping IDE ergonomics, browse Unity Catalog, and edit workspace files without switching to the web interface.
